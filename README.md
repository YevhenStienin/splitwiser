...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/8d7mFO128U)
...
```sh
npx nx serve frontend-ng
```

To create a production bundle:

```sh
npx nx build frontend-ng
```

To see all available targets to run for a project, run:

```sh
npx nx show project frontend-ng
```
